...
<html lang="en">
<head>
    <title id="Description">Pending transactions</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var source =
            {
                ...
                url: "http://52.91.188.107/api/v2/expense/_table/Userentry?fields=Name,Email,iImageID,description&api_key=5a2d2152fecdb383a9c736304c927f9683fc3de4d66184d0feb4c5bd3e59b7d8&filter=(approved%20NE%20N)%20AND%20(approved%20NE%20Y)%20AND%20(Email=%27<%=session.getAttribute("useremail")%>%27)"
            };
    ...
    <div id="table" style="margin-left: 10px;"></div> 
     <div style="float: left; margin-left: 10px;">
        ...
        <div class="col-sm-16">
         ...
         <input type="submit" id="submitbutton2" name="pending" value="Click to view document" hidden>
    </div>
</form>   
</body>
</html>
