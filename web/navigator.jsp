...
function showlocation(){
   ...
   // var x=status;
     ...
     if(x === "Trip recording in progress" ){
           ...
           // document.getElementById('message2').innerHTML = "Click Trip details to know about the trip";
        }
...
<body onload="setTimeout(function() { document.myform.submit() }, 10000)">
   ...
   <span id="message1" hidden value="<%=session.getAttribute("status")%>" > </span> 
...
%>
var textArea = document.getElementById("result3");
...
//code for watch
setInterval(function(){
  if(pastVal !==textArea.value){
    alertNewVal(textArea.value);
    pastVal = textArea.value;
  }
}, 100);

var pastVal = "";
function alertNewVal(val){
  //you will get your new value here
...
$(document).ready(function(){
    ...
    if(document.getElementById('message1').innerHTML === "Trip recording in progress" ){
           
            document.getElementById('start1').disabled=true; 
            document.getElementById('message2').innerHTML="Hi1";
        }
        
        else{
            document.getElementById('stop1').disabled=true; 
            document.getElementById('message2').innerHTML="Hi2";
        }
