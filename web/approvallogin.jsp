<%-- 
    Document   : approvallogin
    Created on : Jun 5, 2016, 2:08:33 AM
    Author     : nikhilv85
--%>
...
<body>
    ...
    <div class="col-lg-5 col-lg-offset-1 mg-top-20">
        <div class="col-lg-8">
            <form id="myform" action="ValidateApprover" method="POST">
               <h4>Approval Login</h4><br></br>
                <!-- Email -->
                <div class="form-group">
                  <label for="submitteremail1">Email address</label>
                  <input type="email" class="form-control" name="submitteremail1" placeholder="Email">
                </div>
                <!-- /Email -->
                <!-- Password -->
                <div class="form-group">
                  <label for="passcode1">Password</label>
                  <input type="password" class="form-control" name="passcode1" placeholder="Password">
                </div>
                <!-- /Password -->
