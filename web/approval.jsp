...
<head>
    ...
    <meta name="description" content="This table shows the transactions that need to be approved">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var source =
            {
                ...
                url: "http://52.91.188.107/api/v2/expense/_table/Userentry?fields=Name,Email,iImageID,description&api_key=5a2d2152fecdb383a9c736304c927f9683fc3de4d66184d0feb4c5bd3e59b7d8&filter=(approved%20NE%20N)%20AND%20(approved%20NE%20Y)%20AND%20(manageremail=%27<%=session.getAttribute("approveremail")%>%27)"
            };
        ...
        function showmessage(){
            ...
            {
                $("#selectionmessage").show();  
                document.getElementById("selectionmessage").innerHTML="Please select row corresponding to transaction";
...
<body class='default' onload="showmessage()">
    <form name="sel" id="selection-form" action="Selection" method="POST"> <br>
    &nbsp;&nbsp;<b> User: <input type="text" id="user" style="border:none;width:600px;margin-left: 5px;" value="<%=session.getAttribute("approvername")%>" ></b>
    <input type="button" value="Logout" name="logout" style="height:10%;width:40%;max-width:150px " onclick="document.location.href='approvallogin.jsp'" /> <br>
    &nbsp;&nbsp;<p id="selectionmessage" style="margin-left:10px;" hidden>&nbsp;&nbsp; </p><br>
    ...
    <div id="table" style="margin-left: 10px;"></div> 
     <div style="float: left; margin-left: 10px;">
        ...
        <div class="col-sm-16">
         ...
         <br></br>
         <input type="button" id="submitselection" value="Submit" onclick="senddata()">
         <input type="button" id="view" value="Click to view document" onclick="viewdoc()">
         <input type="submit" id="submitbutton2" name="receipt" value="Click to view document" hidden>
    </div>
</form>   
</body>
</html>
