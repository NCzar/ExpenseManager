 ...
 * @author nikhilv85
 */
@WebServlet(name = "Sendpassword", urlPatterns = {"/Sendpassword"})
public class Sendpassword extends HttpServlet {
    ...
    String username=(String)session.getAttribute("useremail");
        Test t=new Test();
        String password=t.passwordcheck(username);
        System.out.println(username+" "+password);
       // String youremail="admin@inspiredliving.company";
String text="Hi,"+"\n\nYour password is "+password+" .\n"+"\nRegards,"+"\nInspiredLiving";
                sa.sendmail(text,username);
